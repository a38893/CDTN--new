# Generated by Django 5.1.7 on 2025-06-17 02:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_status', models.CharField(choices=[('pending', 'Đang chờ'), ('confirmed', 'Đã xác nhận'), ('cancelled', 'Đã hủy'), ('completed', 'Đã hoàn thành')], default='pending', max_length=20, verbose_name='Trạng thái lịch hẹn')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.CharField(blank=True, choices=[('test', 'Xét nghiệm'), ('prescription', 'thuốc'), ('deposit', 'Đặt cọc')], default='deposit', max_length=20, null=True, verbose_name='Loại thanh toán')),
